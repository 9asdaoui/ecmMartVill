                    ...
                    @if ($isOutOfStock)
                        <div class="out-of-stock-contact mt-5 p-4 border rounded-md bg-gray-50">
                            <div class="flex items-center justify-between border-b pb-3 mb-3">
                                <h3 class="font-medium text-gray-800 text-lg">{{ __('Product Out of Stock') }}</h3>
                                <span
                                    class="px-2 py-1 bg-red-100 text-red-600 text-xs rounded-md">{{ __('Unavailable') }}</span>
                            </div>

                            <p class="text-gray-600 mb-4">
                                {{ __('This product is currently out of stock. Contact us to check availability.') }}</p>
                            ...
                            <div class="flex flex-col space-y-3">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-blue-600">+123 456 789</span>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="text-blue-600">support@example.com</span>
                                </div>
                            </div>
                        </div>
                    @endif
