        ...
        <div class="flex justify-between layout-wrapper px-4 xl:px-0">
            @if (isset($header['bottom']['show_category']) && $header['bottom']['show_category'] == 1)
                <div class="group group-category dm-sans lg:w-23% md:w-25% h-16 hidden md:block">
                    ...
                    ?>
                    <div
                        class="bg-white border {{ $fixedMenu ? 'transform scale-1 z-30' : 'transform scale-0 group-hover:scale-100 z-40' }} relative h-100 w-full hidden md:block">
                        <div class="accordion-homepage-wrapper">
                            <div
                                class="overflow-hidden tran menu-full-details {{ count($categories) > 8 ? ' height-437p ' : '  ' }} ">
                                @foreach ($categories as $category)
                                    <script>
                                        console.log("Category: {{ $category->product_counts }}");
                                    </script>
                                            ...
                                            @if ($childCategory->categories->count() > 0)
                                                <ul
                                                    ...
                                                    @foreach ($childCategory->categories as $grandChildCategory)
                                                        <li
                                                            class="border-b text-gray-10 w-63 ltr:text-left rtl:text-right">
                                                            <button
                                                                class="w-full category-hover flex items-center outline-none focus:outline-none ltr:text-left rtl:text-right">
                                                                <div
                                                                    class="w-64 h-12 flex-shrink-0 md:mx-0 mx-auto text-center p-1 py-2 relative ltr:md:text-left rtl:md:text-right">
                                    ...
                                    <ul
                                        ...
                                        @foreach ($menu->child as $submenu)
                                            @php
                                                ...
                                                $childUrl =
                                                    str_contains($childUrl, url('/')) || str_contains($childUrl, 'http')
                                                        ? $childUrl
                                                        : url('/' . $childUrl);
                                            @endphp
                                    ...
                                    <div class="relative inline-block ltr:text-left rtl:text-right">
                                        <div style="background: {{ $header['bottom']['bg_color'] }}; color: {{ $header['bottom']['text_color'] }} ;"
                                            ...
                                            <svg class="ltr:mr-2 rtl:ml-2" width="14" height="20"
                                                ...
                                                xmlns="http://www.w3.org/2000/svg">
                                                <mask id="path-1-outside-1_513_1062" maskUnits="userSpaceOnUse" x="2"
                                                    y="0" width="10" height="6" fill="black">
