...
@section('content')
    @php
        $order = App\Models\Order::where('user_id', auth()->user()->id)->orderByDesc('id')->first();
            ...
            <div>
                ...
                <div class="flex flex-wrap jusfti-start items-center gap-3">
                    ...
                    <a href="{{ route('site.userProfile') }}"
                        ...
                        <svg class="neg-transition-scale" width="12" height="12" viewBox="0 0 12 12" fill="none"
                    ...
                    <div class="border border-gray-300 bg-gray-100 ltr:pl-4 ltr:pr-3 rtl:pr-4 rtl:pl-3 py-5 rounded relative">
                        <ul class="flex flex-col gap-4">
                            <li
                                ...
                                <span class="w-5 h-5 mt-1 md:mt-0 neg-transition-scale">
                            ...
                            <li class="inline-block font-normal text-black leading-5">
                                <svg class="inline-block ltr:mr-2 rtl:ml-2 neg-transition-scale" width="18" height="18" viewBox="0 0 18 18" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <li class="inline-block font-normal text-black leading-5">
                                <svg class="inline-block ltr:mr-2 rtl:ml-2 neg-transition-scale" width="18" height="18" viewBox="0 0 18 18"
