...
@section('content')
    @php
        ...
        $userActivities = \DB::table(config('activitylog.table_name'))
            ...
            ->paginate(5);
    @endphp
    <main class="md:w-3/5 lg:w-3/4 w-full main-content flex flex-col flex-1" id="customer_log_activity">
        <section>
            <div class="flex justify-between items-center">
                <p class="text-2xl text-black font-medium">{{ __("Log Activities") }}</p>
                <a class="text-sm font-normal text-gray-400 flex justify-end items-center gap-1 mb-1"
                    href="{{ route('site.userSetting') }}"><svg class="neg-transition-scale" width="16" height="16" viewBox="0 0 16 16" fill="none"
                    ...
                    <tbody>
                        @if(!count($userActivities) == 0)
                            ...
                            @foreach ($userActivities as $activity)
                                ...
                                <tr>
                                    ...
                                    <td class="px-3 py-4">
                                        <span class="font-medium text-sm text-black whitespace-nowrap">{{ $properties['ip_address'] }}</span>
                                    </td>
                                    <td class="px-3 py-4 ltr:text-left rtl:text-right">
                                        <span class="font-medium text-sm text-black whitespace-nowrap">
                        ...
                        @else
                            <tr>
                                <td colspan="6">
                                    <span
                                        class="font-medium text-lg text-neutral-500 text-center flex justify-center flex-col items-center gap-4 py-10 neg-transition-scale">
