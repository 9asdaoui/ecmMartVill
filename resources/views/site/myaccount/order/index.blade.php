...
@section('content')
    @php
        ...
        $statuses = App\Models\OrderStatus::getAll()->sortBy('order_by');
        $filterStatus = false;
    ...
    @endphp
    <main class="md:w-3/5 lg:w-3/4 w-full main-content flex flex-col flex-1" id="customer_orders">
        <section>
            <p class="text-2xl text-black font-medium">{{ __("Order History") }}</p>
                        ...
                        @if ($orders->count())
                            ...
                            <tr>
                                <td class="px-3 py-4 ltr:text-left rtl:text-right">
                                    <a href="{{ route('site.orderDetails', $order->reference) }}" class="flex items-center font-medium text-sm text-black whitespace-nowrap">
                                ...
                                <td class="px-3 py-4 rtl:text-left ltr:text-right">
