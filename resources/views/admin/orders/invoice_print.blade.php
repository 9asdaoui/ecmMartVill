                    ...
                    <thead class="thead">
                        ...
                        <tr>
                            <th colspan="{{ $invoiceSetting?->document?->product_table?->is_image ? 2 : 0 }}">
                                {{ $invoiceSetting?->document?->product_table?->product_label ?? __('Product Name') }}
                            </th>
                    ...
                    <tbody>
                        ...
                        @if($order->shippingTrack)
                            <tr >
                                ...
                                <td class="td" width="25%">
                                    {{ $order->shippingTrack->tracking_link ?? 'No Info' }}
                                </td>
                            </tr>
                        @endif
                        @else
                        ...
                        @if($detail->shippingTrack)
                            <tr>
                                ...
                                <td class="td" width="25%">
                                    {{ $detail->shippingTrack->tracking_link ?? 'No Info' }}
                                </td>
                            </tr>
                        @endif
                        @endforeach
