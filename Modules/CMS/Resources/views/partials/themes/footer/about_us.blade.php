    ...
    <div class="card-body px-0 px-md-4">
        <div class="form-group row my-0">
            ...
            <div class="col-sm-9 input-group bg-transparent">
                <input type="text" class="form-control widget-title inputFieldDesign" name="{{ $layout }}_template_footer[main][about_us][title]" value="{{ isset($footer['main']['about_us']['title']) ? $footer['main']['about_us']['title'] : '' }}" maxlength="40">
            </div>
        </div>
        <hr>
            ...
            <div class="col-sm-7">
                ...
                <div class="preview-image hide-close" id="company_favicon">
                    ...
                    <div class="d-flex flex-wrap mt-2">
                        @if(isset($image['id']['footer_logo']) && $image['id']['footer_logo'])
                            <div class="position-relative border boder-1 p-1 ltr:me-2 rtl:ms-2 rounded mt-2 old-image">
                                ...
                                <img class="upl-img object-contain neg-transition-scale" class="p-1"
                                    src="{{ isset($image['footer_logo']) ? $image['footer_logo'] : '' }}">
                            </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control inputFieldDesign" name="{{ $layout }}_template_footer[main][about_us][data][short_details]" value="{{ isset($footer['main']['about_us']['data']['short_details']) ? $footer['main']['about_us']['data']['short_details'] : '' }}" maxlength="200">
            </div>
        </div>
        <div class="form-group row preview-parent" id="iconTop">
            ...
            <div class="col-sm-7">
                ...
                <div class="preview-image hide-close" id="company_favicon">
                    <!-- img will be shown here -->
                    <div class="d-flex flex-wrap mt-2">
                        @if(isset($image['id']['payment_methods']) && $image['id']['payment_methods'])
                            <div class="position-relative border boder-1 p-1 mr-2 rounded mt-2 old-image">
                                ...
                                <img class="upl-img object-contain neg-transition-scale" class="p-1"
                                    src="{{ isset($image['payment_methods']) ? $image['payment_methods'] : '' }}">
                            </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control inputFieldDesign" name="{{ $layout }}_template_footer[main][about_us][data][download_app]" value="{{ isset($footer['main']['about_us']['data']['download_app']) ? $footer['main']['about_us']['data']['download_app'] : '' }}" maxlength="50">
            </div>
        </div>
        ...
        <div class="form-group row preview-parent" id="iconTop">
            ...
            <div class="col-sm-7">
                ...
                <div class="preview-image hide-close" id="company_favicon">
                    <!-- img will be shown here -->
                    <div class="d-flex flex-wrap mt-2">
                        @if(isset($image['id']['google_play']) && $image['id']['google_play'])
                            <div class="position-relative border boder-1 p-1 mr-2 rounded mt-2 old-image">
                                <div
                                    class="position-absolute rounded-circle text-center img-delete-icon"
                                ...
                                <img class="upl-img object-contain neg-transition-scale" class="p-1"
                                    src="{{ isset($image['google_play']) ? $image['google_play'] : '' }}">
                            </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control inputFieldDesign" name="{{ $layout }}_template_footer[main][about_us][data][google_play_link]" value="{{ isset($footer['main']['about_us']['data']['google_play_link']) ? $footer['main']['about_us']['data']['google_play_link'] : '' }}">
            </div>
        </div>
        ...
        <div class="form-group row preview-parent" id="iconTop">
            ...
            <div class="col-sm-7">
                ...
                <div class="preview-image hide-close" id="company_favicon">
                    <!-- img will be shown here -->
                    <div class="d-flex flex-wrap mt-2">
                        @if(isset($image['id']['app_store']) && $image['id']['app_store'])
                            <div class="position-relative border boder-1 p-1 mr-2 rounded mt-2 old-image">
                                <div
                                    class="position-absolute rounded-circle text-center img-delete-icon"
                                ...
                                <img class="upl-img object-contain neg-transition-scale" class="p-1"
                                    src="{{ isset($image['app_store']) ? $image['app_store'] : '' }}">
                            </div>
                        @endif
                    </div>
                </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control inputFieldDesign" name="{{ $layout }}_template_footer[main][about_us][data][app_store_link]" value="{{ isset($footer['main']['about_us']['data']['app_store_link']) ? $footer['main']['about_us']['data']['app_store_link'] : '' }}">
            </div>
        </div>
    </div>
</div>
