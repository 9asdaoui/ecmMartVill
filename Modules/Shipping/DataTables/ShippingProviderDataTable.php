    ...
    public function ajax(): JsonResponse
    {
        ...
        return datatables()
            ...
            ->editColumn('name', function ($provider) {
                ...
                if ($this->hasPermission(['Modules\Shipping\Http\Controllers\ShippingController@updateProvider'])) {
                    $str .= $edit;
                }

                if ($this->hasPermission(['Modules\Shipping\Http\Controllers\ShippingController@removeProvider'])) {
                    $str .= $delete;
                }
    ...
    public function html()
    {
        return $this->builder()
            ...
            ->addColumn([
                ...
                'visible' => $this->hasPermission(['Modules\Shipping\Http\Controllers\ShippingController@updateProvider', 'Modules\Shipping\Http\Controllers\ShippingController@removeProvider']),
